...
from app.schemas import PostResponse, UserProfileModel, UserDb, RequestEmail, UserResponse, RequestRole
from app.services.auth import auth_service
from app.services.roles import RoleChecker
from app.conf.messages import NOT_FOUND, USER_ROLE_EXISTS, INVALID_EMAIL, USER_NOT_ACTIVE, USER_ALREADY_NOT_ACTIVE,\
    USER_CHANGE_ROLE_TO
...
@router.get("/users_with_username/{username}", response_model=List[UserDb],
