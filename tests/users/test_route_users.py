...
from app.conf.messages import INVALID_EMAIL, NOT_FOUND, OPERATION_FORBIDDEN, USER_ALREADY_NOT_ACTIVE, USER_CHANGE_ROLE_TO, USER_NOT_ACTIVE, USER_ROLE_EXISTS
